...
// SPDX-FileCopyrightText: 2012 The uOFW team <uofwteam@gmail.com>
// SPDX-License-Identifier: BSD-3-Clause
// PSP Software Development Kit - https://github.com/pspdev
// uOFW project - https://github.com/uofw
#include <assert.h>
#include <ctype.h>
#include <getopt.h>
#include <libgen.h>
...
{
	fprintf(stderr, "Usage: %s [-v] <in_elf> <out_prx>\n", g_progname);
	fprintf(stderr, "Generate a stripped PRX for PSP FW kernel module\n");
